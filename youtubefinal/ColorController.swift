...
class ColorController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let leftSwipe = UISwipeGestureRecognizer(target: self,action: #selector(ColorController.HandleSwipe(_:)))
        let RigthSwipe = UISwipeGestureRecognizer(target: self,action: #selector(ColorController.HandleSwipe(_:)))
