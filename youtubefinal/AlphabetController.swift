...
class AlphabetController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let leftSwipe = UISwipeGestureRecognizer(target: self,action: #selector(AlphabetController.HandleSwipe(_:)))
        let RigthSwipe = UISwipeGestureRecognizer(target: self,action: #selector(AlphabetController.HandleSwipe(_:)))
