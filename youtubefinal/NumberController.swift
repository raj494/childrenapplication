...
class NumberController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let leftSwipe = UISwipeGestureRecognizer(target: self,action: #selector(NumberController.HandleSwipe(_:)))
        let RigthSwipe = UISwipeGestureRecognizer(target: self,action: #selector(NumberController.HandleSwipe(_:)))
