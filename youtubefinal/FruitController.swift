...
class FruitController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let leftSwipe = UISwipeGestureRecognizer(target: self,action: #selector(FruitController.HandleSwipe(_:)))
        let RigthSwipe = UISwipeGestureRecognizer(target: self,action: #selector(FruitController.HandleSwipe(_:)))
